...
library(xlsx)
mydata <- read.xlsx("/Users/poojasengupta/Documents/Teaching/Text Analytics/Cereal Data.xlsx", 1)

# read in the worksheet named mysheet
mydata <- read.xlsx("/Users/poojasengupta/Documents/Teaching/Text Analytics/Cereal Data.xlsx", sheetName = "Cereal Data")

# read the csv 
mydata <- read.csv("/Users/poojasengupta/Documents/Teaching/Text Analytics/Future50_restaurants.csv", header = TRUE)
#library(tidyverse)
mydata <- read.csv("/Users/poojasengupta/Documents/Teaching/Text Analytics/Future50_restaurants.csv", header = FALSE)
head(mydata)
#####################Subsetting data######################
